...
import {CompetencesContainer, CompetencesH3, CompetencesH1, CompetencesCard, CompetencesIcon, CompetencesP, CompetencesH2, CompetencesWrapper, Additionnal} from './CompetencesElements'
import "./dots.css"
    ...
    return (
        <CompetencesContainer id="competences">
                ...
                <div ref={containerRef}>
                    <Slider {...settings}>
                        <CompetencesCard>
                            ...
                            <CompetencesP>
                            Conseil - Rédaction d'actes - Démarches et formalités juridiques
                            </CompetencesP>
                            <CompetencesH3>Défense Judiciaire</CompetencesH3>
                            <CompetencesP>
                            Assistance et représentation en justice sur tout le territoire national
                            </CompetencesP>
                        ...
                        <CompetencesCard>
                            ...
                            <CompetencesP>
                            Modifications statutaires - Cession de parts sociales - Dissolution - Liquidation
                            </CompetencesP>
                        ...
                        <CompetencesCard>
                            ...
                            <CompetencesP>
                                - <strong>Divorce</strong> à l'amiable ou contentieux<br />
                                - Prestation compensatoire<br />
                                - <strong>Séparation</strong><br />
                                - Liquidation du régime matrimonial ou de l'indivision<br />
                                - Autorité parentale<br />
                                - Pension alimentaire (fixation ou revalorisation)<br />
                                - Résidence de l'enfant<br />
                                - Convention parentale<br />
                        ...
                        <CompetencesCard>
                            ...
                            <CompetencesP>
                                ...
                                - <strong>Licenciement</strong> pour cause réelle et sérieuse<br />
                                - <strong>Licenciement</strong> pour faute grave<br />
                                - <strong>Licenciement</strong> pour inaptitude<br />
                                - <strong>Licenciement</strong> pour motif économique<br />
                        ...
                        <CompetencesCard>
                            ...
                            <CompetencesP>Je développe un nouveau domaine, tenant de ma maturité et d’un <strong>long chemin</strong>: la  réparation du préjudice corporel.</CompetencesP>
                            <CompetencesP>Moi-même victime d’un <strong>accident grave</strong> de la circulation en 1993, je suis aujourd’hui prête à vous accompagner sur ce lourd parcours, avec toute ma <strong>compréhension, ma motivation et mon empathie.</strong></CompetencesP>
                        </CompetencesCard>            
                        ...
                        <CompetencesCard>
                            ...
                            <CompetencesP>
                                ...
                                - Clauses abusives<br />
                                -<strong> Ruptures abusives</strong> des relations commerciales<br />
                                - Bail Commercial<br />
                                -Recouvrement de créances<br />
                                -<strong> Procédures </strong>collectives<br />
                                -<strong> Tribunal de Commerce</strong><br />
                                -Saisie - Exécution<br />
                                -<strong> Droit de la Responsabilité</strong> (civile, contractuelle)<br />
                                -<strong> Litige locatif</strong> (bail d'habitation - impayés - trouble de jouissance - insalubrité)<br />
                                -<strong>Tribunal Judiciaire</strong>
                            </CompetencesP>
                        </CompetencesCard>
                    </Slider>
                </div>
            ...
            <Additionnal style={{textAlign:'center', maxWidth:'1200px'}}>
                <CompetencesH2 style={{color:'white', margin:'4rem 0 1rem', textAlign:'center'}}>COMPÉTENCE ET PLAIDOIRIE SUR TOUT LE TERRITOIRE NATIONAL</CompetencesH2>
                ...
                <CompetencesP style={{color:'white', textAlign:'justify'}}>
                    Inscrite au Barreau de Senlis, j'interviens également au titre de l'<strong>aide juridictionnelle</strong>. 
                    L'avocat que vous pouvez choisir, doit nécessairement être inscrit au Barreau dont dépend la Juridiction qui examinera l'affaire. 
                    Les honoraires d'avocat seront pris en charge selon le barème de l'aide juridictionnelle.
                </CompetencesP>
            </Additionnal>
